...
def get_websearch_agent(character_name: str) -> Runnable:
    web_search_tool = TavilySearchResults(k=3, description="A tool for searching the modern web.")

    system_template = """
You are {character_name}. You are speaking directly to a user from the modern world.
...
Speak in your own voice as {character_name}.
